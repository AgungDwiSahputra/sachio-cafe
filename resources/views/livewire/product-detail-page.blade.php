                ...
                <div class="flex flex-wrap -mx-4">
                        ...
                        <div class="sticky top-0 z-50 overflow-hidden ">
                            ...
                            <div class="flex-wrap hidden md:flex ">
                                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='https://m.media-amazon.com/images/I/71f5Eu5lJSL._SX679_.jpg'">
                                    <img src="https://m.media-amazon.com/images/I/71f5Eu5lJSL._SX679_.jpg" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-yellow-500">
                                </div>

                                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='https://m.media-amazon.com/images/I/61XPhYGQOQL._SX679_.jpg'">
                                    <img src="https://m.media-amazon.com/images/I/61XPhYGQOQL._SX679_.jpg" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-yellow-500">
                                </div>

                                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='https://m.media-amazon.com/images/I/81v5JNjZ4-L._SX679_.jpg'">
                                    <img src="https://m.media-amazon.com/images/I/81v5JNjZ4-L._SX679_.jpg" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-yellow-500">
                                </div>
                    ...
                    <div class="w-full px-4 md:w-1/2 ">
                        <div class="lg:pl-20">
                            ...
                            <div class="w-32 mb-8 ">
                                <label for="" class="w-full pb-1 text-xl font-semibold text-gray-700 border-b border-yellow-300 dark:border-gray-600 dark:text-gray-400">Quantity</label>
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                <button class="w-full p-4 bg-yellow-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-yellow-600 dark:bg-yellow-500 dark:hover:bg-yellow-700">
                                    Add to cart</button>
                            </div>
                        </div>
                    </div>
