        ...
        <div class="max-w-screen-xl mx-auto px-6 flex flex-col lg:flex-row justify-between items-center w-full">
            ...
            <div class="lg:w-1/2 text-center lg:text-left">
                ...
                <div class="flex justify-center lg:justify-start space-x-4">
                    <button class="px-6 py-3 bg-yellow-500 text-black font-semibold rounded-lg hover:bg-yellow-700">
                        Order Now
                    </button>
                    <button class="px-6 py-3 border border-yellow-500 text-yellow-500 font-semibold rounded-lg hover:bg-yellow-600 hover:text-black">
                        See Menu
                    </button>
                </div>
            </div>
